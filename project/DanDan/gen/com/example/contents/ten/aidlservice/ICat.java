...
public static abstract class Stub extends android.os.Binder implements com.example.contents.ten.aidlservice.ICat
{
private static final java.lang.String DESCRIPTOR = "com.example.contents.ten.aidlservice.ICat";
...
/**
 * Cast an IBinder object into an com.example.contents.ten.aidlservice.ICat interface,
 * generating a proxy if needed.
 */
public static com.example.contents.ten.aidlservice.ICat asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.example.contents.ten.aidlservice.ICat))) {
return ((com.example.contents.ten.aidlservice.ICat)iin);
}
return new com.example.contents.ten.aidlservice.ICat.Stub.Proxy(obj);
}
...
private static class Proxy implements com.example.contents.ten.aidlservice.ICat
{
