...
import com.example.contents.eighteen.LinkMainActivity;
...
import com.example.contents.nineteen.NineteenContentsActivity;
import com.example.contents.seven.SevenContentsActivity;
import com.example.contents.seventeen.SeventeenContentsActivity;
import com.example.contents.six.SixContentsActivity;
import com.example.contents.sixteen.SixteenContentsActivity;
			...
			mList.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View source,
					...
					case CHAPTER_SIX:
						...
						break;
					case CHAPTER_SEVEN:
						Intent seven_chapter_intent = 
							new Intent(ContentsActivity.this, SevenContentsActivity.class);
						startActivity(seven_chapter_intent);
						break;
					case CHAPTER_EIGHT:
					...
					case CHAPTER_SIXTEEN:
						Intent sixteen_intent 
							= new Intent(ContentsActivity.this, SixteenContentsActivity.class);
						startActivity(sixteen_intent);
						break;
					case CHAPTER_SEVENTEEN:
						Intent seventeen_intent 
							= new Intent(ContentsActivity.this, SeventeenContentsActivity.class);
						startActivity(seventeen_intent);
						break;
					case CHAPTER_EIGHTEEN:
						Intent eighteen_intent 
							= new Intent(ContentsActivity.this, LinkMainActivity.class);
						startActivity(eighteen_intent);
						break;
					case CHAPTER_NINETEEN:
						Intent nineteen_intent 
							= new Intent(ContentsActivity.this, NineteenContentsActivity.class);
						startActivity(nineteen_intent);
						break;
				    default:
				    	break;
					}
